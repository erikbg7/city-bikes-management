...
var HomePage = (function () {
    ...
    HomePage.prototype.reload = function () {
        ...
        this.http.get("https://api.waqi.info/feed/barcelona/?token=9da5f1c00d33a9a028ccde26fda95d05c7b46e3e")
            .toPromise()
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/rogersanchezvital/Desktop/3B/EA/air-pollution-tutorial/src/app/app.html"*/`<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>`/*ion-inline-end:"/Users/rogersanchezvital/Desktop/3B/EA/air-pollution-tutorial/src/app/app.html"*/
        }),
